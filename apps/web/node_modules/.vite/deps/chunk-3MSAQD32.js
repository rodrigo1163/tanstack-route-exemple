// ../../node_modules/.pnpm/@tanstack+router-devtools-core@1.134.12_@tanstack+router-core@1.134.12_@types+node@22.1_faaf467b80d48961e213b767c08a34ca/node_modules/@tanstack/router-devtools-core/dist/index-Cb5eH-Od.js
var sharedConfig = {
  context: void 0,
  registry: void 0,
  effects: void 0,
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-BgDBabIx-NESJ7VZX.js"));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-CtXUAvZF-PNXRNMKW.js").then((n) => n.c));
...
//# sourceMappingURL=chunk-3MSAQD32.js.map
